...
## ⚡️ Добри практики, които да следваме!

**Всяко парче код събмитнато към курса трябва да отговаря на следните критерии:**

- Използвайте `formatter` и `linter` за да пишете конвенционално код!
- Всеки ред трябва да е максимум 81 символа!
- Не трябва да има влагания по-дълбоки от 5!
- Индентация - 2 `space`-a!
- Всеки израз да има декларация на типа!
- Да няма ф-ии по-дълги от 20 реда! (не броим `helper` ф-иите в `where`)!
...
- Седмица 8 - **Функтор, апликатив, монада и още**
  ...
  - 🎥 [Запис](#)
  - 📜 [Материали](./week-8)
  - 🌟 **[Бонус задача - JsonParser](./week-8#Задачи)**
