...
- Седмица 1 - **Функционален стил. Интро в Хаскел** - _15.10.2020_

  - 🎥 [Запис](https://drive.google.com/file/d/1_oZFATqP4YQynCPb4CVnq1P78d9nQ7oT/view?usp=sharing)
  - 📜 [Материали](./week-1)

- Седмица 2 - **Pattern matching. Where, Let in, Case** - _22.10.2020_
...
- Седмица 3 - **Функции от по висок ред. Currying. Map, filter. Извикване и композиция на функции** - _29.10.2020_
...
- Седмица 4 - **Ламбда функции. За типовете (Typeclasses)** - _05.11.2020_
...
- Седмица 5 - **Модули. Зареждане на модули. Вградени модули (Data - Map, List, Set) Писане на модули** - _12.11.2020_
